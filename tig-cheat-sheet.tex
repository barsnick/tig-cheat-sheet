...
\usepackage[pdfauthor={Philippe Miossec},
            pdftitle={Tig Cheat Sheet},
            pdfsubject={Tig Cheat Sheet}]{hyperref}
...
\verb!m! & Main. & \verb!p! & Pager. & \verb!t! & Directory tree.\\
\verb!d! & Diff. & \verb!r! & Refs. & \verb!f! & File blob.\\
\verb!l! & Log. & \verb!S! & Status. & \verb!y! & Stash.\\
\verb!B! & Blame. & \verb!c! & Stage. & \verb!h! & Help.\\
\end{tabular}
...
\verb!<! & Return to blame for the child commit. \\
\end{tabular}
...
\section{Stash View (c)}
\begin{tabular}{@{}lp{6.5cm}@{}}
\verb!A! & Apply selected stash \\
\verb!P! & Pop selected stash \\
\verb#!# & Drop selected stash \\
\end{tabular}
